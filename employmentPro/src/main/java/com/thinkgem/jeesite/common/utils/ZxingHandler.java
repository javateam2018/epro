...
public class ZxingHandler {
	...
	public static void encode(String contents, int width, int height, String imgPath) {
		int codeWidth = 3 + // start guard 开始防护
				(7 * 6) + // left bars
				5 + // middle guard
				(7 * 6) + // right bars
				3; // end guard
	...
	public static void main(String[] args) {
		...
		System.out.println("finished zxing EAN-13 encode.完成了zxing EAN-13编码");

		String decodeContent = ZxingHandler.decode(imgPath);
		System.out.println("解码内容如下：" + decodeContent);
		System.out.println("finished zxing EAN-13 decode.完成了zxing EAN-13解码");
		...
		System.out.println("finished zxing encode.完成了zxing编码");

		String decodeContent2 = ZxingHandler.decode2(imgPath2);
		System.out.println("解码内容如下：" + decodeContent2);
		System.out.println("finished zxing decode.完成了zxing解码");
